                ...
                <Box w={'950px'} m={'auto'} >
                    ...
                    <Grid templateColumns='32% 66%' gap={5}>
                        ...
                        <Box bg={'white'} rounded={6} p={5} boxShadow={'lg'} pt={'50px'}>
                            <IntroText title={`Studied at `} icon={MdSchool} />
                            <IntroText title={`Went to `} icon={MdAccountBalance} />
                            <IntroText title={`Lives in `} icon={MdMapsHomeWork} /> 
                            <IntroText title={`From `} icon={MdPlace} /> 
